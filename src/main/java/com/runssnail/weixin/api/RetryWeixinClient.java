...
public class RetryWeiXinClient implements WeiXinClient {
    ...
    public RetryWeiXinClient(WeiXinClient delegate) {
    ...
    public WeiXinClient getDelegate() {
        return delegate;
    }

    public void setDelegate(WeiXinClient delegate) {
        this.delegate = delegate;
    }
