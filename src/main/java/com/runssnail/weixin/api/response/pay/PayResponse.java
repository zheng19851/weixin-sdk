...
import com.runssnail.weixin.api.exception.SignException;
 ...
 * @author zhengwei
 */
public abstract class PayResponse extends Response {
    ...
    public void check(String paySignKey) throws PayApiException {
        ...
        if (!SignUtils.validateSign(this.getResponseBody().toString(), paySignKey)) {
            throw new SignException("validate sign error, responseBoy=" + this.getResponseBody() + ", sign=" + this.sign);
        }
